...
function tryToBuyMostCostEffective() {
    var cpsFiveMins = Game.cookiesPs * 10 * 60;
    console.log("Five: " + cpsFiveMins); 
    ...
    Game.UpgradesInStore.forEach((e) => {
        ...
        if(building && e.baseDesc.toLowerCase().includes("twice")) {
            ...
            var affordability = (Game.cookiesPs * 10 * 60) / basePrice;
    ...
    if(oneToBuy != null /*&& Game.cookies >= oneToBuy.price*/) {
